...
export const BottomNav = () => {
  return (
    <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="flex items-center gap-1 p-2 bg-white/70 backdrop-blur-xl border border-white/40 rounded-[24px] shadow-lg shadow-black/5">
        <NavItem to="/" icon={<Home size={22} />} label="Projects" />
        <NavItem to="/project/demo" icon={<Compass size={22} />} label="Explore" />
