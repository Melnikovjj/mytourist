                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem', marginTop: '0.5rem' }}>
                        <button 
                            ...
                            onClick={() => window.location.href = 'https://mytourist-production-c45e.up.railway.app/api/auth/yandex'}
                        >
                        ...
                        <button 
                            ...
                            onClick={() => window.location.href = 'https://mytourist-production-c45e.up.railway.app/api/auth/mailru'}
                        >
