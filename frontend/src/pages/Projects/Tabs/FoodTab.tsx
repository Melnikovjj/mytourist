        ...
        <div className="space-y-6">
            ...
            {nutrition && (
                <GlassCard className="p-4 bg-gradient-to-br from-orange-50 to-orange-100/50 border-orange-200/50">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        ...
                        <div className="text-center">
                            <div className="text-[10px] text-gray-500 uppercase tracking-wider">Угл</div>
                            ...
                            <GlassCard key={meal.id} className="p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                                ...
                                <div className="space-y-2">
                                    {meal.products?.map((p) => (
                                        <div key={p.id} className="flex items-center justify-between text-sm group">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <span className="text-xs text-gray-400">{p.gramsPerPerson}г</span>
                                                <span className="text-xs text-gray-400">{p.caloriesPer100g} ккал</span>
                                    ...
                                    {(!meal.products || meal.products.length === 0) && (
                                        <p className="text-xs text-gray-400 italic text-center py-2">Продукты не добавлены</p>
                                    )}
                                </div>
                            </GlassCard>
                        ))}
            ...
            {meals.length === 0 && !loading && (
                <div className="text-center py-8">
                    ...
                    <div className="text-lg font-medium text-gray-900">План питания пуст</div>
                    <p className="text-sm text-gray-500">Добавьте приемы пищи для расчета</p>
                </div>
            )}
                ...
                {showAddMeal && (
                    <motion.div className="fixed inset-0 bg-black/50 z-50 flex items-end"
                        ...
                        <motion.div className="bg-white w-full rounded-t-[32px] p-6 pb-10"
                            ...
                            <h2 className="text-xl font-bold mb-6">Добавить Прием Пищи</h2>

                            <div className="space-y-4">
                                <div>
                                    <label className="text-sm font-medium text-gray-500 mb-1 block">Номер дня</label>
                                ...
                                <div>
                                    <label className="text-sm font-medium text-gray-500 mb-1 block">Тип приема</label>
                ...
                {showAddProduct && (
                    <motion.div className="fixed inset-0 bg-black/50 z-50 flex items-end"
                        ...
                        <motion.div className="bg-white w-full rounded-t-[32px] p-6 pb-10 max-h-[90vh] overflow-y-auto"
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="text-sm font-medium text-gray-500 mb-1 block">Название продукта</label>
                                    <input className="input w-full p-3 rounded-xl bg-gray-50 border border-gray-200" placeholder="Напр. Овсянка"
                                        value={productForm.name} onChange={(e) => setProductForm({ ...productForm, name: e.target.value })} />
                                </div>
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="text-sm font-medium text-gray-500 mb-1 block">Грамм/чел</label>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <div>
                                        <label className="text-sm font-medium text-gray-500 mb-1 block">Углеводы</label>
                                        <input className="input w-full p-3 rounded-xl bg-gray-50 border border-gray-200" type="number"
